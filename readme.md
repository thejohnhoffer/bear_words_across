...
- [Copy this project](https://github.com/thejohnhoffer/bewo/wiki/Contributing) for use with your own [AWS](https://en.wikipedia.org/wiki/Amazon_Web_Services) endpoints. 
